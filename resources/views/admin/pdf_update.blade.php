      ...
      @include('admin.partials.error')
        <div class="card card-primary">
            ...
            <div class="card-body">
             ...
             <form action="{{ route('admin.pdf.update', $pdf->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
                @method('PUT')
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    ...
                    style="background-image: url({{ asset("/uploads/images/$pdf->image") }}); background-size: cover; background-position: center center;">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <input type="text" name="title" class="form-control" value="{{ $pdf->title }}">
                  </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                      <input type="file" name="pdf" class="form-control" value="{{ $pdf->pdf }}">
                    </div>
                  </div>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <select class="form-control selectric" name="category">
                      ...
                      <option {{ $pdf->category == $category->id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <textarea id="ckeditor" name="description">{{ $pdf->description }}</textarea>
                  </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <label class="custom-switch mt-2">
                      <input {{ $pdf->status === 1 ? 'checked' : '' }} type="checkbox" name="status" class="custom-switch-input">
